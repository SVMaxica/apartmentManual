...
export const CheckIn = () => {
  return (
    <AmenityPage
      title="Check In"
      wrapperClassName="check-in-wrapper"
      infoClassName="check-in"
    >
      <p className="check-in-text">
        ...
        <img
          ...
          src="images/keybox.jpg"
          alt="Keybox no. 3 to the left of the main entrance"
        />
        <br />
        <br />
        ...
        <img
          ...
          alt="Map of the garage showing parking spot 112"
        />
        <br />
        <br />
