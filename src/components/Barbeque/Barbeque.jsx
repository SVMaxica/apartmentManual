    ...
    <div className="barbeque-wrapper">
      <div className="barbeque-info">
        ...
        <div className="barbeque-instructions">
          <p>
            Unfortiently there are strict regulations for fire and barbeques,
            but we have 2 very beautiful places were you can barbeque if you:
          </p>
          <ol>
          ...
          <ul>
            ...
            <li>
              And the second one is next to the famous rouk Snäckchimpansen wich
